...
button:hover { background-color: #a66d3a; }
.links { margin-top: 20px; }
.links a { display: block; margin: 8px 0; text-decoration: none; color: #7b4f27; font-weight: bold; }
.links a:hover { color: #a66d3a; }
.msg { margin-bottom: 15px; padding: 10px; border-radius: 8px; font-weight: bold; }
...
<div class="container">
    ...
    <form action="../controllers/cadastrar_usuario.php" method="post" novalidate>
